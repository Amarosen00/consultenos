...
/**
 * Pantalla EXTRA (fuera de las 12 HU de docs/IMPLEMENTACION.md, equivale a
 * HU-13): listado rapido de tickets activos con cambio de estado inline.
 *
 * Se construyo antes de conocer el documento de implementacion; se mantuvo
 * por decision explicita del usuario. El listado "oficial" con filtros
 * (HU-08/16/06/07) y doble clic a detalle es vista/ListadoTickets.java.
 *
...
public class ListadoActivosExtra extends JFrame {
    ...
    public ListadoActivosExtra(int idEmpleadoLogueado) {
        this.idEmpleadoLogueado = idEmpleadoLogueado;

        setTitle("Consultenos - Tickets Activos (extra)");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ListadoActivosExtra(4).setVisible(true));
    }
}
